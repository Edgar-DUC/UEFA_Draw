...
def index_CL():
    return render_template("test.html", title="UEFA Champions League Draw", l_b="UEFA Europa League", r_b="UEFA Europa Conference League", redirect_g="index_EL", redirect_d="index_ECL", bottom="https://www.lequipe.fr/tv/")
